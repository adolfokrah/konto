...
class WalkThroughLegacy extends StatefulWidget {
  const WalkThroughLegacy({super.key});

  @override
  State<WalkThroughLegacy> createState() => _WalkThroughLegacyState();
}

class _WalkThroughLegacyState extends State<WalkThroughLegacy> {
