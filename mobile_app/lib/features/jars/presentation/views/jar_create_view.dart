              ...
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                return Container(
                  decoration: BoxDecoration(
                    color: Theme.of(
                      context,
                    ).colorScheme.surface.withValues(alpha: scrollProgress),
                  ),
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize:
                                24.0 - (4.0 * scrollProgress), // From 24 to 20
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CategorySelector(
                        ...
                        selectedCategory:
                            selectedJarGroup.isEmpty ? null : selectedJarGroup,
                      ...
                      const SizedBox(height: AppSpacing.spacingM),
                      const Text('Currency', style: TextStyles.titleMedium),
                      const SizedBox(height: AppSpacing.spacingM),
                      CurrencyPicker(
