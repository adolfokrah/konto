      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        <div className="bg-white p-3 rounded">
          ...
          <ul className="space-y-1">
            <li>Current: <code className="bg-gray-100 px-1 rounded">{currentLocale}</code></li>
            <li>Path: <code className="bg-gray-100 px-1 rounded">{getPathWithoutLocale()}</code></li>
          </ul>
        </div>
        ...
        <div className="bg-white p-3 rounded">
          ...
          <ul className="space-y-1">
            <li>{t('home')} | {t('about')} | {t('contact')}</li>
            <li>{t('login')} | {t('signup')}</li>
          </ul>
        </div>
      </div>
